...
// let resultDiesEl = document.getElementById("result-dies");

// let dice1 =
//  'div class="container"<div></div><div></div><div></div><div></div><div class="special"></div><div></div><div></div><div></div><div></div></div>';

// let dice2 =
//  '<div class="container"><div class="special"></div><div></div><div></div><div></div><div></div><div class="special"></div><div></div><div></div><div></div></div>';
...
// function play(){
//     let diesRoll = Math.ceil(Math.random() * 6 );
//     if (diesRoll === 1){
//         resultDiesEl.innerHTML = dice1;
//     } 
//      else if (diesRoll === 2){
//          resultDiesEl.innerHTML = dice2;
//     }
//      else if (diesRoll === 3){
//          resultDiesEl.innerHTML = dice3;
//     }
//     else if (diesRoll === 4){
//          resultDiesEl.innerHTML = dice4;
//     }
//     else if (diesRoll === 5){
//          resultDiesEl.innerHTML = dice5;
//     }
//     else if (diesRoll === 6){
//          resultDiesEl.innerHTML = dice6;
//     }
...
let userEmailEl = document.getElementById("email");
let userPasswordEl = document.getElementById("password");
let userMessageEl = document.getElementById("message");
